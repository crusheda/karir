...
@section('content')
        ...
        <div class="container pt-17 pb-15 py-sm-17 py-xxl-20">
            <div class="row">
                <div class="col-sm-9 col-xxl-5 text-center text-sm-start" data-cues="slideInDown" data-group="page-title" data-interval="-200" data-delay="500">
                    ...
                    <div>
                        <a href="https://simgos.rspkusukoharjo.com:1111/apps/RegOnline/" target="_blank" class="btn btn-lg btn-dark rounded me-2 mb-3"><i class="fas fa-user me-2"></i> Reservasi Online</a>
        ...
        <div class="container py-5 py-md-10">
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-8">
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Rumah sakit kami menawarkan layanan kesehatan yang terintegrasi, yang berarti pasien dapat menerima perawatan dari
                                berbagai disiplin ilmu medis dalam satu tempat, memudahkan koordinasi antar dokter dan tim medis, serta mempercepat proses penyembuhan.</p>
                        </div>
                    </div>
                </div>
                <!--/column -->
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        <div>
                            <img src="{{ asset('img/icons/lineal/award-2.svg') }}" class="svg-inject icon-svg icon-svg-sm text-yellow me-5" alt="" />
                        </div>
                        <div>
                            <h4 class="fs-20 ls-sm">Pelayanan Paripurna</h4>
                            <p class="mb-0">Kami terus berinovasi dan mengembangkan diri untuk terus memberikan layanan yang paripurna bagi Pasien. Dengan mengikuti
                                perkembangan teknologi medis terkini, serta meningkatkan kualitas SDM melalui pelatihan dan sertifikasi, </p>
                        </div>
                    </div>
                </div>
                <!--/column -->
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        <div><img src="{{ asset('img/icons/lineal/balance.svg') }}" class="svg-inject icon-svg icon-svg-sm text-orange me-5" alt="" />
                        </div>
                        <div>
                            <h4 class="fs-20 ls-sm">Berbasis Islami</h4>
                            <p class="mb-0">Kami mempunyai komitmen untuk pelayanan yang lengkap dan ramah pada setiap pengunjung dengan tetap mengutamakan kaidah islami.
                                Kami berusaha untuk menjaga etika dan nilai-nilai Islam dalam setiap aspek pelayanan maupun perawatan yang penuh perhatian dan kasih sayang.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        <div>
                            <img src="{{ asset('img/icons/lineal/user.svg') }}" class="svg-inject icon-svg icon-svg-sm text-pink me-5" alt="" />
                        </div>
                        <div>
                            <h4 class="fs-20 ls-sm">Tenaga Medis Profesional</h4>
                            <p class="mb-0">Kami memiliki tim medis yang terdiri dari dokter spesialis, perawat, dan tenaga kesehatan lainnya yang berkompeten dan
                                berpengalaman di bidangnya. Setiap tenaga medis kami dilatih untuk memberikan pelayanan yang terbaik dengan perhatian penuh
                                terhadap pasien.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Rumah sakit kami dilengkapi dengan fasilitas medis terkini, termasuk ruang operasi, laboratorium, radiology, ruang perawatan intensif,
                                dan peralatan berteknologi tinggi lainnya guna mendukung pelayanan medis yang akurat dan optimal untuk mencapai hasil yang terbaik.</p>
                        </div>
                    </div>
                </div>
                <!--/column -->
                <div class="col-md-6 col-lg-4">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            ...
                            <p class="mb-0">Kami selalu berusaha untuk berinovasi dan mengembangkan layanan kami, baik dalam hal teknologi medis maupun dalam prosedur
                                perawatan, guna memastikan bahwa kami memberikan pelayanan yang tidak hanya memenuhi harapan pasien, tetapi juga mengikuti perkembangan
                                medis terkini.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-0 pb-5">
            <div class="row">
                <div class="col-md-6 mb-10">
                    <img src="{{ asset('/img/penunjang/ambulance1.png') }}" width="600" style="max-width: 100%" alt="">
                </div>
                <div class="col-md-6">
    ...
    <section class="wrapper bg-gray position-relative min-vh-60 d-lg-flex align-items-center">
        <div class="col-lg-6 position-lg-absolute top-0 end-0 image-wrapper bg-image bg-cover h-100"
            data-image-src="{{ asset('img/photos/bg39.jpg') }}">
        ...
        <div class="container pb-14 pb-md-14 mb-lg-18 mb-xl-18">
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center mb-14 mb-md-18">
            <div class="col-lg-6 position-relative">
              ...
              <div class="row gx-md-5 gy-5 position-relative">
                <div class="col-6">
                  <img class="img-fluid rounded shadow-lg mb-5" data-cue="fadeIn" data-delay="300" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                  <img class="img-fluid rounded shadow-lg d-flex col-10 ms-auto" data-cue="fadeIn" data-delay="600" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                </div>
                <!-- /column -->
                <div class="col-6">
                  <img class="img-fluid rounded shadow-lg my-5" data-cue="fadeIn" data-delay="900" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                  <img class="img-fluid rounded shadow-lg d-flex col-10" data-cue="fadeIn" data-delay="1200" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                </div>
                <!-- /column -->
              </div>
              <!-- /.row -->
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center mb-14 mb-md-18">
            <div class="col-lg-6 position-relative order-lg-2">
              ...
              <div class="row gx-md-5 gy-5 position-relative">
                <div class="col-5">
                  <img class="img-fluid rounded shadow-lg my-5 d-flex ms-auto" data-cue="fadeIn" data-delay="300" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                  <img class="img-fluid rounded shadow-lg d-flex col-10 ms-auto" data-cue="fadeIn" data-delay="600" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                </div>
                <!-- /column -->
                <div class="col-7">
                  <img class="img-fluid rounded shadow-lg mb-5" data-cue="fadeIn" data-delay="900" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                  <img class="img-fluid rounded shadow-lg d-flex col-11" data-cue="fadeIn" data-delay="1200" src="{{ asset('img/photos/sa12.jpg') }}" srcset="{{ asset('img/photos/sa1@2x.jpg') }} 2x" alt="" />
                </div>
                <!-- /column -->
              </div>
              <!-- /.row -->
          ...
          <div class="row text-center" data-cue="slideInUp">
            <div class="col-lg-10 mx-auto">
              <div class="mt-lg-n20 mt-xl-n22 position-relative">
                ...
                <video poster="{{ asset('media/thumbnail.jpg') }}" class="player" playsinline controls preload="none">
                  <source src="{{ asset('media/profil.mp4') }}" type="video/mp4">
                  {{-- <source src="{{ asset('media/movie.html') }}" type="video/webm"> --}}
                </video>
              </div>
            </div>
            <!--/column -->
          ...
          <div class="row text-center mt-12">
            <div class="col-lg-9 mx-auto">
              ...
              <div class="row gx-lg-8 gx-xl-12 process-wrapper text-center mt-9" data-cues="slideInUp" data-group="process">
                <div class="col-md-4"> <img src="{{ asset('img/icons/lineal/shield.svg') }}" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
                  <h4 class="mb-1">1. Secured Transactions</h4>
                  <p>Etiam porta malesuada magna mollis euismod sem.</p>
                </div>
                <!--/column -->
                <div class="col-md-4"> <img src="{{ asset('img/icons/lineal/shield.svg') }}" class="svg-inject icon-svg icon-svg-md text-green mb-3" alt="" />
                  <h4 class="mb-1">2. Budget Planning</h4>
                  <p>Etiam porta malesuada magna mollis euismod sem.</p>
                </div>
                <!--/column -->
                <div class="col-md-4"> <img src="{{ asset('img/icons/lineal/shield.svg') }}" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
        ...
        <div class="container py-5 py-md-10">
            <div class="row gy-10 gy-sm-13 gx-md-8 gx-xl-12 align-items-center mb-10 mb-md-12">
                <div class="col-lg-6">
                    <div class="row gx-md-5 gy-5">
                        <div class="col-md-6">
                            <figure class="rounded"><img src="{{ asset('img/photos/g14.jpg') }}"
                                    srcset="{{ asset('img/photos/g14@2x.jpg') }} 2x" alt=""></figure>
                        </div>
                        <!--/column -->
                        <div class="col-md-6 align-self-end">
                            <figure class="rounded"><img src="{{ asset('img/photos/g15.jpg') }}"
                                    srcset="{{ asset('img/photos/g15@2x.jpg') }} 2x" alt=""></figure>
                        </div>
                        <!--/column -->
                        <div class="col-12">
                            <figure class="rounded mx-md-5"><img src="{{ asset('img/photos/g16.jpg') }}"
                                    srcset="{{ asset('img/photos/g16@2x.jpg') }} 2x" alt=""></figure>
                        </div>
                        <!--/column -->
                    </div>
                    <!--/.row -->
                ...
                <!--/column -->
                <div class="col-lg-6">
                    <h2 class="fs-15 text-uppercase text-muted mb-3">Pelayanan Kami</h2>
                    <h3 class="display-3 ls-sm mb-5">Berbagai Layanan yang disediakan</h3>
                    <p class="mb-6">Dengan fasilitas yang modern dan dilengkapi peralatan medis mutakhir, kami menyediakan berbagai layanan medis mulai
                        dari pemeriksaan kesehatan rutin, perawatan intensif, hingga penanganan kondisi medis yang kompleks. Kami senantiasa berupaya
                    ...
                    <div class="row gy-3 gx-xl-8">
                        <div class="col-xl-6">
                            <ul class="icon-list bullet-dark mb-0">
                                ...
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Layanan Poliklinik Spesialis</span></li>
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Layanan Laboratorium</span></li>
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Layanan Radiology</span></li>
                            </ul>
                        </div>
                        <!--/column -->
                        <div class="col-xl-6">
                            <ul class="icon-list bullet-dark mb-0">
                                <li><span><i class="uil uil-check"></i></span><span>Layanan Rawat Inap dan Intensif</span></li>
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Layanan Gawat Darurat (IGD)</span></li>
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>Layanan Kamar Operasi dan Bedah</span></li>
                            </ul>
                        </div>
                        <!--/column -->
                    </div>
            ...
            <div class="row position-relative">
                <figure class="rounded position-absolute d-none d-lg-block"
                    ...
                    <img src="{{ asset('img/pku/gedung/drone-pku.jpg') }}" srcset="{{ asset('img/pku/gedung/drone-pku.jpg') }} 2x" alt="">
                </figure>
