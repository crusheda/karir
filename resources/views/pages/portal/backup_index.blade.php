    ...
    <div class="content-wrapper">
        ...
        <section id="home">
            <div class="wrapper bg-gray">
                <div class="container pt-10 pt-md-12 pb-14 pb-md-17 text-center">
                    <div class="row text-center">
                        <div class="col-lg-9 col-xxl-7 mx-auto" data-cues="zoomIn" data-group="welcome" data-interval="-200">
                            <h1 class="display-2 mb-4"><span class="underline-3 style-2 primary"><em>ASRI</em></span></h1>
                            <h2 class="">Amanah. Santun. Ramah. Ikhlas.</h2>
                            <p class="lead fs-18 lh-sm px-md-5 px-xl-15 px-xxl-10">Menjadi Rumah Sakit Pilihan Yang Islami Dengan Pelayanan<br>Cepat Dan Ramah</p>
                        </div>
                        <!-- /column -->
                    </div>
                    <!-- /.row -->
        ...
        <div class="container pt-17 pt-md-19 pb-14 pb-md-16">
            <div class="row gy-6 gy-lg-0">
                ...
                <div class="col-md-12 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title  mb-3">Lebih dekat dengan Kami</h4>
                                    ...
                                    <div id="mc_embed_signup_scroll2">
                                        <div class="mc-field-group input-group form-floating">
                                            <input type="email" value="" name="EMAIL"
                                                class="required email form-control" placeholder="Alamat Surel"
                                                id="mce-EMAIL2">
                                            <label for="mce-EMAIL2">Alamat Surel</label>
                                            <input type="submit" value="Kirim" name="subscribe"
                                                id="mc-embedded-subscribe2" class="btn btn-primary " disabled>
                                        </div>
