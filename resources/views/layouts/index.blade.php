          ...
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
              ...
              <div class="offcanvas-footer d-lg-none">
                <div>
                  <a href="cdn-cgi/l/email-protection.html#7d1b140f0e0953111c0e093d18101c1411531e1210" class="link-inverse"><span class="__cf_email__" data-cfemail="d1b8bfb7be91b4bcb0b8bdffb2bebc">[email&#160;protected]</span></a>
        ...
        <div class="container pt-10 pt-md-14 pb-14 pb-md-17 text-center">
          ...
          <div class="row text-center mt-10">
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
              <figure><img class="w-auto" src="img/illustrations/i8.png" srcset="./img/illustrations/i8@2x.png 2x" alt="" /></figure>
            </div>
            <!-- /column -->
          </div>
          <!-- /.row -->
        ...
        <div class="container py-14 py-md-17">
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-6 gy-md-0 text-center">
            <div class="col-md-6 col-lg-3">
              <img src="img/icons/lineal/megaphone.svg" class="svg-inject icon-svg icon-svg-md text-blue mb-3" alt="" />
              <h4>Marketing</h4>
            ...
            <!--/column -->
            <div class="col-md-6 col-lg-3">
              <img src="img/icons/lineal/target.svg" class="svg-inject icon-svg icon-svg-md text-green mb-3" alt="" />
              <h4>Strategy</h4>
              <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
            </div>
            <!--/column -->
            <div class="col-md-6 col-lg-3">
              <img src="img/icons/lineal/settings-3.svg" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
              <h4>Development</h4>
              <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
            </div>
            <!--/column -->
            <div class="col-md-6 col-lg-3">
              <img src="img/icons/lineal/bar-chart.svg" class="svg-inject icon-svg icon-svg-md text-orange mb-3" alt="" />
              <h4>Data Analysis</h4>
              <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
            </div>
            <!--/column -->
      ...
      <div class="wrapper bg-gray">
        <div class="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
            <div class="col-lg-7">
              <figure><img class="w-auto" src="img/illustrations/i3.png" srcset="./img/illustrations/i3@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
              ...
              <div class="d-flex flex-row mb-4">
                <div>
                  <img src="img/icons/lineal/light-bulb.svg" class="svg-inject icon-svg icon-svg-sm text-blue me-4" alt="" />
                </div>
                <div>
              ...
              <div class="d-flex flex-row mb-4">
                <div>
                  <img src="img/icons/lineal/pie-chart-2.svg" class="svg-inject icon-svg icon-svg-sm text-green me-4" alt="" />
                </div>
                <div>
              ...
              <div class="d-flex flex-row">
                <div>
                  <img src="img/icons/lineal/design.svg" class="svg-inject icon-svg icon-svg-sm text-yellow me-4" alt="" />
                </div>
                <div>
          ...
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-7 order-lg-2">
              <figure><img class="w-auto" src="img/illustrations/i2.png" srcset="./img/illustrations/i2@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
      ...
      <div class="wrapper bg-gray">
        <div class="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-6 mb-15 align-items-center">
            <div class="col-lg-7 order-lg-2">
              <figure><img class="w-auto" src="img/illustrations/i4.png" srcset="./img/illustrations/i4@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
    ...
    <section id="contact">
      <div class="wrapper bg-light">
        <div class="container py-14 py-md-17">
          <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-lg-7">
              <figure><img class="w-auto" src="img/illustrations/i5.png" srcset="./img/illustrations/i5@2x.png 2x" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-lg-5">
              ...
              <div class="d-flex flex-row">
                ...
                <div>
                  ...
                  <p class="mb-0"><a href="cdn-cgi/l/email-protection.html#9ceffdf2f8fef3e4dcf9f1fdf5f0b2fff3f1" class="link-body"><span class="__cf_email__" data-cfemail="6b180a050f0904132b0e060a020745080406">[email&#160;protected]</span></a></p>
                </div>
              </div>
            </div>
            <!--/column -->
      ...
      <div class="row gy-6 gy-lg-0">
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <a href="cdn-cgi/l/email-protection.html#694a"><span class="__cf_email__" data-cfemail="6a03040c052a0f070b030644090507">[email&#160;protected]</span></a><br /> 00 (123) 456 78 90
          </div>
          <!-- /.widget -->
        </div>
        <!-- /column -->
