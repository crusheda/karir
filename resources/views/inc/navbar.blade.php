<ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="nav-item"><a class="dropdown-item {{ request()->routeIs('pengumuman.index') ? 'active' : '' }}" href="javascript:void(0);">Pengumuman</a></li>
            <li class="nav-item"><a class="dropdown-item {{ request()->routeIs('rekrutmen.index') ? 'active' : '' }}" href="javascript:void(0);">Registrasi</a></li>
        </ul>
    </li>
