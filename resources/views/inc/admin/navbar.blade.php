...
<header class="app-header sticky" id="header">
    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-left">
            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="index.html" class="header-logo">
                        <img src="{{ asset('img/logo/logo_new_dark.png') }}" alt="logo" class="desktop-logo">
                        <img src="{{ asset('img/logo/logo_new_dark.png') }}" alt="logo" class="toggle-logo">
                        <img src="{{ asset('img/logo/logo_new_light.png') }}" alt="logo" class="desktop-dark">
            ...
            <!-- Start::header-element -->
            <div class="header-element mx-lg-0 mx-2 sidemenu-toggle header-link animated-arrow hor-toggle horizontal-navtoggle">
        ...
        <ul class="header-content-right">
            ...
            {{-- <li class="header-element country-selector dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon" width="32" height="32"
                        ...
                        <line x1="135.97" y1="184" x2="215.97" y2="184" fill="none"
                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
                        <line x1="87.97" y1="32" x2="87.97" y2="56" fill="none"
                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
                        <line x1="23.97" y1="56" x2="151.97" y2="56" fill="none"
                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
                        <path d="M120,56a96,96,0,0,1-96,96" fill="none" stroke="currentColor" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="16" />
                        <path d="M61.44,88A96,96,0,0,0,152,152" fill="none" stroke="currentColor"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="16" />
                    </svg>
                </a>
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/us_flag.jpg" alt="img">
                            </span>
                            English
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/spain_flag.jpg" alt="img">
                            </span>
                            español
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/french_flag.jpg" alt="img">
                            </span>
                            français
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/uae_flag.jpg" alt="img">
                            </span>
                            عربي
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/germany_flag.jpg" alt="img">
                            </span>
                            Deutsch
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/china_flag.jpg" alt="img">
                            </span>
                            中国人
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/italy_flag.jpg" alt="img">
                            </span>
                            Italiano
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                <img src="/img/mamix/flags/russia_flag.jpg" alt="img">
                            </span>
                            Русский
                        </a>
                    </li>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="ecommerce-search.html" class="btn btn-secondary-light btn-sm btn-wave">Continue
                    ...
                    <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                            ...
                            <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-md bg-gray-300">
                                        <img src="/img/mamix/ecommerce/png/30.png" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            <a href="ecommerce-customer-cart.html">SoundSync Headphones</a>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-md bg-gray-300">
                                        <img src="/img/mamix/ecommerce/png/31.png" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            <a href="ecommerce-customer-cart.html">Western Ladies Bag</a>
                                            <div class="fs-11 text-muted">
                                                <span>Qty : 1,</span>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-md bg-gray-300">
                                        <img src="/img/mamix/ecommerce/png/32.png" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            <a href="ecommerce-customer-cart.html">Elitr Alarm Clock</a>
                                            <div class="fs-11 text-muted">
                                                <span>Qty : 2,</span>
                                                <span>Color : <span class="text-cart-alaramclock fw-semibold">Sky
                                                        Blue</span></span>
                                            </div>
                                        </div>
                                        <div class="text-end">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-md bg-gray-300">
                                        <img src="/img/mamix/ecommerce/png/12.png" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            <a href="ecommerce-customer-cart.html">Aus Polo Assn</a>
                                            <div class="fs-11 text-muted">
                                                <span>Qty : 3,</span>
                                                <span>Color : <span class="text-cart-sweatshirt fw-semibold">Soft
                                                        Peach</span></span>
                                            </div>
                                        </div>
                                        <div class="text-end">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex align-items-center cart-dropdown-item gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-md bg-gray-300">
                                        <img src="/img/mamix/ecommerce/png/16.png" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between mb-0">
                                        <div class="mb-0 fs-14 fw-medium">
                                            <a href="ecommerce-customer-cart.html">Smart Watch</a>
                                            <div class="fs-11 text-muted">
                                                <span>Qty : 1,</span>
                                                <span>Color : <span class="text-cart-smartwatch fw-semibold">Crimson
                                                        Red</span></span>
                                            </div>
                                        </div>
                                        <div class="text-end">
                    ...
                    <div class="p-3 empty-header-item border-top">
                        ...
                        <div class="text-center d-grid">
                            <a href="ecommerce-customer-checkout.html" class="btn btn-primary btn-wave">Proceed to
                                checkout</a>
                        </div>
                    </div>
            ...
            <li class="header-element dropdown">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-xl-2 me-0">
                            @if (empty($foto_profil->filename))
                                <img src="{{ asset('img/user.png') }}" alt="img" class="avatar avatar-sm avatar-rounded">
                            @else
                                <img src="{{ url('https://simrsmu.com/storage/'.substr($foto_profil->filename,7,1000)) }}" alt="img" class="avatar avatar-sm avatar-rounded">
                            @endif
                            {{-- <img src="/img/mamix/faces/14.jpg" alt="img" class="avatar avatar-sm avatar-rounded"> --}}
                        </div>
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <i class="ti ti-settings me-2 fs-18 text-orange"></i>Settings
                        </a>
                    </li>
