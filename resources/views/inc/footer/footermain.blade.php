<footer class="bg-gray">
    <div class="container py-13 py-md-15">
        {{-- <div class="d-lg-flex flex-row align-items-lg-center">
            <h3 class="display-3 ls-sm mb-6 mb-lg-0 pe-lg-20 pe-xl-22 pe-xxl-25">Ikuti berita terbaru Kami</small></h3>
            <a href="javascript:void(0);" class="btn btn-lg btn-primary rounded mb-0 text-nowrap">Ikuti Sekarang</a>
        </div> --}}
        <!--/div -->
        ...
        <div class="row gy-6 gy-lg-0">
            ...
            <div class="col-md-4 col-lg-5">
                <div class="widget">
                    <h4 class="widget-title ls-sm mb-3">Kunjungi Kami</h4>
                                ...
                                <div id="mc_embed_signup_scroll2">
                                    <div class="mc-field-group input-group form-floating">
                                        ...
                                        <input type="submit" value="Join" name="subscribe"
                                            id="mc-embedded-subscribe2" class="btn btn-dark " disabled>
                                    </div>
